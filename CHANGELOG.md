...
### Changed
- Use [BioGenerics](https://github.com/BioJulia/BioGenerics.jl/tree/v0.1.0).
- Use [BioSequence](https://github.com/BioJulia/BioSequences.jl/tree/v2.0.0) v2.0 or higher.
- Updated CI.

### Removed
- :exclamation: BAM and SAM modules were moved to [XAM.jl](https://github.com/BioJulia/XAM.jl).
...
[2.0.0]: https://github.com/BioJulia/BioAlignments.jl/compare/v1.0.0...v2.0.0
